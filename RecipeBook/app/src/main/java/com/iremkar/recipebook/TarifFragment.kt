package com.iremkar.recipebook
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menu")){
                //yeni bir yemek eklenecek
                ...
                //daha once eklenen yemek gosterilecek
    ...
    fun gorselSec(view: View){
        ...
        activity?.let {
            //ContextCompat versiyonlar arasi uyum icin
